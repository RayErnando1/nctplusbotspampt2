...
def banner():
    ...
    autoketik (f"""
     ...
     \033[1;0m──────────────────────────┬─────────────────────────
  \033[1;0m┌────────────────────────────┼───────────────────────────┐
  {W}│ Creator{R}:{W}RAYDEV         │ Version {R}:{G} 3.0{W}             │
  {W}| Addition{R}:{W}NCT Plus          |                        {W}   |
  {W}│ Github{R}:{G}github.com/RayErnando1 {W}│ {W}Your Ip {R}:{Y} {ip}      {W}│
  {W}│ Youtube{R}:{W}RAYDEV {biru} channel      {W}│ Perfect Brutal {biru}Sms Tools  {W}│
  └────────────────────────────┼───────────────────────────┘""")
...
# Copyright By RAYDEV PRODUCTION INDO 18/11/22 
Footer